    ...
    <div className='flex gap-10 my-20'>
      ...
      <div className='flex-1'>
        ...
        <ul className="flex justify-start my-4 ">
          <strong className='mr-2'>Tag</strong>{tags.map(li => <li className="rounded-full text-[#23BE0A] bg-gray-100 text-sm py-1 px-2 me-1 ">{li}</li>)}
        </ul>
        <hr className="border my-3 border-gray-300" />
        ...
        <button className="btn btn-outline btn-accent me-3">Read</button>
